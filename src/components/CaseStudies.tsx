...
const CaseStudies = () => {
  ...
  return (
    <section id="case-studies" className="py-24 bg-surface-secondary">
      <div className="swiss-grid fade-in">
        ...
        <div className="col-span-12 space-y-16">
          {caseStudies.map((study, index) => (
            <div key={index} className="grid lg:grid-cols-12 gap-8 bg-surface-primary border border-swiss-light overflow-hidden">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-4 lg:mt-0">
                      <div className="flex items-center space-x-2 text-text-tertiary">
                        <Calendar size={16} />
                        <span className="text-caption">{study.duration}</span>
                      </div>
                      <div className="flex items-center space-x-2 text-text-tertiary">
                        <Users size={16} />
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="inline-flex items-center space-x-2 px-6 py-3 bg-text-primary text-surface-primary hover:bg-swiss-gray transition-colors duration-200"
                    >

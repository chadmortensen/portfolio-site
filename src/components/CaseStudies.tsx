      ...
      <div className="swiss-grid fade-in">
        ...
        <div className="col-span-12 space-y-12 sm:space-y-16">
          {caseStudies.map((study, index) => (
            <div key={index} className="grid lg:grid-cols-12 gap-6 sm:gap-8 bg-surface-primary border border-swiss-light overflow-hidden">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="pt-4">
                    <button 
                      ...
                      className="inline-flex items-center space-x-2 px-6 py-3 bg-text-primary text-surface-primary hover:bg-swiss-gray transition-colors duration-200 w-full sm:w-auto justify-center sm:justify-start"
                    >

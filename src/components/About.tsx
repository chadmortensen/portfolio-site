    ...
    <section id="about" className="section-divider mondrian-teal">
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 min-h-[500px]">
          {/* Background Section */}
          <div className="mondrian-orange md:col-span-3 flex items-center justify-center p-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Background</h3>
            </div>
          </div>
          
          <div className="mondrian-white md:col-span-9 flex items-center justify-center p-8">
            <p className="text-mondrian-black leading-relaxed text-lg max-w-4xl">
          ...
          {/* Passion Section - Full width row */}
          <div className="mondrian-navy md:col-span-12 flex items-center justify-center p-8">
          ...
          <div className="mondrian-white md:col-span-8 flex items-center justify-center p-8">
            <p className="text-mondrian-black leading-relaxed text-lg max-w-3xl">
          ...
          <div className="mondrian-coral md:col-span-4 flex items-center justify-center p-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Outside of Work</h3>
            </div>
          </div>
        </div>
      </div>

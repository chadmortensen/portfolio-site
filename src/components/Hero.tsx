        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-3 text-center">
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6 px-4">
              <p className="text-body text-text-tertiary max-w-3xl mx-auto leading-relaxed">Yes, I used AI tools to create this portfolio. I even used an LLM to rewrite some of the content. Do know that I approve of and stand behind everything on this website as truth.</p>
